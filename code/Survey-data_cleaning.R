...
triennial <- filter(commercial_species, project != "Groundfish Slope and Shelf Combination Survey", year < 2004)
triennial_trawl <- filter(trawl_data, project != "Groundfish Slope and Shelf Combination Survey", year < 2004)
