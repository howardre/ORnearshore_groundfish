...
## decades
eighties_data <- grid_data(30, 25, 1980, 1990, trawl_counts)
nineties_data <- grid_data(30, 25, 1989, 2000, trawl_counts)
thousands_data <- grid_data(30, 25, 1999, 2010, trawl_counts)
teens_data <- grid_data(30, 25, 2009, 2018, trawl_counts)
...
par(mfrow = c(1, 4),
    family = 'serif',
    mar = c(4, 5, 3, .3) + .1)
grid_map(30, 25, 1980, 1990, trawl_counts, eighties_data, "Fishing Effort 1980s", bathy_dat, bathy_mat)
grid_map(30, 25, 1989, 2000, trawl_counts, nineties_data, "Fishing Effort 1990s", bathy_dat, bathy_mat)
grid_map(30, 25, 1999, 2010, trawl_counts, thousands_data, "Fishing Effort 2000s", bathy_dat, bathy_mat)
grid_map(30, 25, 2009, 2018, trawl_counts, teens_data, "Fishing Effort 2010s", bathy_dat, bathy_mat)
